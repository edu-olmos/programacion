...
--Necesitamos conocer los nombres de las ciudades de aquellos clientes 
--cuyo domicilio es en calle "San Martin", empleando subconsulta.
...
-- Obtenga la misma salida anterior pero empleando join.
 ...
 select distinct ci.nombre
  ...
  -- Obtenga los nombre de las ciudades de los clientes cuyo 
  --apellido no comienza con una letra específica, empleando subconsulta
...
--Pruebe la subconsulta del punto 5 separada de la consulta exterior 
